...
public class ButtonEditSelectD extends RelativeLayout {
    ...
    public static final int BUTTON_TYPE_SELECT_SECOND_INPUT2 = 11;
    ...
    private EditText btn_edit_edit_input2 = null;
    ...
    private void initView(Context context) {
        View.inflate(context, R.layout.base_button_edit_seletct_d_layout, this);
        ...
        btn_edit_edit_input2 = (EditText) findViewById(R.id.btn_edit_edit_input2);
    ...
    /*    btn_edit_query_btn.setBackgroundResource(R.drawable.ui_base_btn_selector);
        if (BUTTON_TYPE_SELECTTWO_INPUT_QUERY == type) {
            ...
            btn_edit_linearLayout.setVisibility(GONE);
            btn_edit_edit_input.setVisibility(VISIBLE);
            btn_edit_edit_input2.setVisibility(GONE);

        } else if (BUTTON_TYPE_SELECT_SECOND_INPUT2 == type) {
            btn_edit_edit_select_2.setEnabled(false);
            btn_edit_linearLayout.setVisibility(GONE);
            btn_edit_edit_input.setVisibility(VISIBLE);
            btn_edit_edit_input2.setVisibility(VISIBLE);
    ...
    public void showInput2(boolean isShow) {
        if (isShow) {
            btn_edit_edit_input2.setVisibility(VISIBLE);
        } else {
            btn_edit_edit_input2.setVisibility(GONE);
    ...
    public void setHint(String... parm) {
        if (!TextUtils.isEmpty(parm[0])) {
            if (btn_edit_edit_input != null) {
                btn_edit_edit_input.setVisibility(VISIBLE);
                btn_edit_edit_input.setText("");
                SpannableString ss = new SpannableString(parm[0]);//定义hint的值
                AbsoluteSizeSpan ass = new AbsoluteSizeSpan(18, true);//设置字体大小 true表示单位是sp
                ss.setSpan(ass, 0, ss.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                btn_edit_edit_input.setHint(new SpannedString(ss));
            }
        }
        if (parm.length > 1) {
            if (btn_edit_edit_input2 != null) {
                btn_edit_edit_input2.setText("");
                SpannableString ss = new SpannableString(parm[1]);//定义hint的值
                AbsoluteSizeSpan ass = new AbsoluteSizeSpan(18, true);//设置字体大小 true表示单位是sp
                ss.setSpan(ass, 0, ss.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                btn_edit_edit_input2.setHint(new SpannedString(ss));
            }
        }
    ...
    public void hideSele2() {
        btn_edit_linearLayout.setVisibility(GONE);
        btn_edit_edit_select.setText("");
        btn_edit_edit_select_2.setEnabled(false);

    }

    public void showSele2(String msg, String hint) {
        btn_edit_linearLayout.setVisibility(VISIBLE);
        btn_edit_edit_select.setText("");
        btn_edit_edit_select_2.setEnabled(false);
        btn_edit_edit_select.setEnabled(false);
        ...
        if (!TextUtils.isEmpty(msg)) {
            if (btn_edit_edit_select != null) {
                ...
                AbsoluteSizeSpan ass = new AbsoluteSizeSpan(18, true);//设置字体大小 true表示单位是sp
                ss.setSpan(ass, 0, ss.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                btn_edit_edit_select.setHint(new SpannedString(ss));
            }
        }
    ...
    public void setButtonIputHint(String hit) {
        if (btn_edit_edit_input != null) {
            btn_edit_edit_input.setHint(hit);
        }
    }
    ...
    public String getButtonEditInput2Text() {
        String strData = "";
        if (null == btn_edit_edit_input2) {
            return strData;
        }
        strData = btn_edit_edit_input2.getText().toString();
        return strData;
    }
