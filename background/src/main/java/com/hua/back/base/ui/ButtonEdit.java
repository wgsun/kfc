...
public class ButtonEdit extends RelativeLayout {
    ...
    public static final int BUTTON_TYPE_EDIT = 1;//编辑类型
    public static final int BUTTON_TYPE_SELECT = 2;//选择类型
    ...
    private void initView(Context context) {
        View.inflate(context, R.layout.base_button_edit_layout, this);
        ...
        btn_edit_query_btn.setTextSize(25);
        ...
        btn_edit_display.setTextSize(25);
        setButtonType(BUTTON_TYPE_EDIT);
        // LayoutInflater.from(context).inflate(R.layout.ui_base_button_edit_layout, this, true);
        // View contentView = View.inflate(context, R.layout.ui_base_button_edit_layout, null);
        // addView(contentView);
    }
...
//            btn_edit_select_btn.setVisibility(GONE);
    ...
    public void setButtonEditTextColor(int color) {
        if (btn_edit_edit_select != null) {
            btn_edit_edit_select.setTextColor(color);
        }
    }
