...
public class CrashHandlerCom implements Thread.UncaughtExceptionHandler {
	...
	public void uncaughtException(Thread thread, Throwable ex) {
		...
		XssTrands.getInstanll().LoggerError(TAG,"uncaughtException   exception: "+exception);
		if (!handleException(ex) && mDefaultHandler != null) {
			...
			System.exit(1);
			if (mContext != null) {
				mContext.startService(new Intent(mContext, ComVendService.class));
			}
		}
	}
